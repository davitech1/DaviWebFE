  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"/><span class="icon-bar"/><span class="icon-bar"/></button><NuxtLink class="navbar-brand" to="/">Davi</NuxtLink>
          </div>
          <div id="custom-collapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Features</a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="alerts-and-wells.html"><i class="fa fa-bolt"/> Alerts and Wells</a></li>
                  <li><a href="buttons.html"><i class="fa fa-link fa-sm"/> Buttons</a></li>
                  <li><a href="tabs_and_accordions.html"><i class="fa fa-tasks"/> Tabs &amp; Accordions</a></li>
                  <li><a href="content_box.html"><i class="fa fa-list-alt"/> Contents Box</a></li>
                  <li><a href="forms.html"><i class="fa fa-check-square-o"/> Forms</a></li>
                  <li><a href="icons.html"><i class="fa fa-star"/> Icons</a></li>
                  <li><a href="progress-bars.html"><i class="fa fa-server"/> Progress Bars</a></li>
                  <li><a href="typography.html"><i class="fa fa-font"/> Typography</a></li>
                </ul>
              </li>
              ...
              <li><NuxtLink to="/access" >Login</NuxtLink>
              </li>
            </ul>
          </div>
        </div>
